...
def main(args):
	...
	args.decoder_vocab_path = "../vocabulary/decoder_vocab.pkl"
	args.encoder_vocab_path = "../vocabulary/encoder_vocab.pkl"

	# print(os.listdir('./'))
	# print(os.listdir('../vocabulary'))
	# print(os.listdir(args.decoder_vocab_path))
	...
	elif args.model == 'image_cnn_all_inputs':
		from seq2seq_all_inputs.model import UtteranceAndImageCnnEncoder
		encoder = UtteranceAndImageCnnEncoder(args, train_dl, encoder_vocab)
		print('encoder: UtteranceAndImageCnnEncoder is loaded')
	
	elif args.model == 'image_cnn_utterances_and_block_region_counters':
		from seq2seq_all_inputs.model import ImageAndUtterancesAndBlockRegionCountersEncoder
		encoder = ImageAndUtterancesAndBlockRegionCountersEncoder(args, train_dl, encoder_vocab)
...
if __name__ == '__main__':
	...
	# io
	parser.add_argument('--model_path', type=str, default='/datadrive/saved_data/mc-architect/model/', help='path for saving trained models')
	parser.add_argument('--pretrained_models_dir', type=str, default=None, help='path for pretrained LMs')
	parser.add_argument('--saved_dataset_dir', type=str, default='/datadrive/saved_data/mc-architect/data/cwc/scratch/lower-no_perspective_coords-fixed', help='path for saved dataset to use')
